                ...
                <div className="options-container">
                    <div className="option">
                        <label>
                            ...
                            <p>
                                I agree to the <span className="text-highlight">general booking </span>
                                conditions and <span className="text-highlight">privacy policy</span>
                            </p>
                        </label>
                    </div>
                </div>
                <Link to="/bookingconfirmation" type="submit" className="btn btn--primary full-width">
